...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-3 ">
              <div class="site-logo">
                <a href="index.html" class="font-weight-bold">
                  <img src="/blog/images/logo.png" alt="Image" class="img-fluid">
                </a>
              </div>
            </div>
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('/blog/images/hero_1.jpg')">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-12">
              <span class="d-block mb-3 text-white" data-aos="fade-up"><%=blog.getCreatedDate() %> <span class="mx-2 text-primary">&bullet;</span> by <%= blog.getUser().getFirstname() %></span>
              ...
              <c:forEach items="${blog.comments}" var="comment">
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    ...
                    <div class="meta">${comment.createdDate } at ${comment.createdTime}</div>
                    <p>${comment.content}</p>
